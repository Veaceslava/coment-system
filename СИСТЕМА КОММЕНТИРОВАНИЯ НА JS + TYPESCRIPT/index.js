...
let select = function() {
    ...
    function saveComments() {                                     // сохраняем в Local
    ...
    function showComments() {                                    // рисуем отправленный коммент
        ...
        comments.forEach(function(item) {
           ...
           out += `<div class="toolbar-sent">
                       ...
                       <button onclick="addInfavorite()" class="button-bordernone" id="toggle-favorite">
    ...
    function addInfavorite() {
        let toggle = document.querySelectorAll('#toggle-favorite');

        toggle.forEach( item => {
            
            item.innerHTML = `<svg class="toolbar-sent_svg-heartempty" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g opacity="0.4">
        ...
        /* alert('Click is working, but after restart'); */
    }
